...
namespace AsyncProgramming.CharmanderDTO
{
    //¡¡¡CREAR DTO A PARTIR DE JSON!!!

    /*Con el .json de la pokeapi copiado, creamos una clase, la borramos 
     * para que no haya nada => edit/special paste/paste json as class */
